<nav class="flex justify-between w-full h-[70px] px-10 items-center bg-[#BEC9DE]">
    ...
    <ul class="flex items-center space-x-6">
        ...
        <li class="font-semibold text-xl relative {{request()->is("posts/create")  ? "text-blue-800 font-bold before:content before:absolute before:bottom-0 before:left-0 before:w-full before:h-[3px] before:bg-blue-800" : "text-black"}}  hover:text-blue-800 hover:font-bold ">
            <a href="{{route("create")}}">Creat Post</a>
        </li>
